...
class ChatService
{
    ...
    public function ask(string $question, array $history): string
    {
        ...
        8. When your answer draws on a specific page, article, project, or video, include its link at the end so the user can read more (e.g. 'You can read more here: <url>'). If a URL is provided in the context for the content you used, you SHOULD include it — don't omit it. Only use URLs that actually appear in the context or known facts; never invent or guess a
